...
namespace Basalt.UI
{
    ...
    public partial class App : Application
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            string languageCode = Basalt.UI.Properties.Settings.Default.UserLanguage;
        ...
        private string GetLanguageFromRegistry()
        {
            try
            {
                using (RegistryKey key = Registry.CurrentUser.OpenSubKey(@"Software\Basalt"))
                {
                    if (key != null)
                    {
        ...
        public static void ApplyLanguage(string langCode)
        {
            ...
            try
            {
                ...
                Basalt.UI.Properties.Settings.Default.UserLanguage = langCode;
