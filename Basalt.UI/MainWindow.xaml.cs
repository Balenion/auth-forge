...
namespace Basalt.UI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            string currentLang = Basalt.UI.Properties.Settings.Default.UserLanguage;
        ...
        {
            var savePicker = new SaveFileDialog { Filter = "Excel Files|*.xlsx", FileName = "Basalt_Template.xlsx" };
        ...
        private async void StartHashing_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (savePicker.ShowDialog() == true)
                {
                    ...
                    string successTitle = GetLocalizedText("m_SuccessTitle", "Hashing Complete");
        ...
        private void GenerateKey_Click(object sender, RoutedEventArgs e)
        {
            ...
            GeneratedKeyTotpTxt.Text = Base32Encoding.ToString(keyBytes).TrimEnd('=');
        }
        ...
        private void ChangeLanguage_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                Basalt.UI.Properties.Settings.Default.UserLanguage = targetLangCode;
                Basalt.UI.Properties.Settings.Default.Save();
                UpdateActiveSettingsInfo();
            }
            catch (Exception ex)
            {
