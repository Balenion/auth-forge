...
namespace AuthForge.Core.Tests
{
    public class JwtServiceTests
    {
        ...
        public void GenerateSecretKey_ShouldReturnValidBase64String(int bits)
        {
            ...
            // Act
            string base64Key = jwtService.GenerateSecretKey(bits);
        ...
        public void GenerateSecretKey_CallsShouldBeUnique()
        {
            ...
            // Act
            string key1 = jwtService.GenerateSecretKey(512);
            string key2 = jwtService.GenerateSecretKey(512);
        ...
        public void GenerateSecretKey_WithInvalidBits_ShouldThrowArgumentException(int invalidBits)
        {
            ...
            // Act & Assert
            Assert.ThrowsAny<System.Exception>(() => jwtService.GenerateSecretKey(invalidBits));
        }
    }
}